    ...
    public sealed class CurveFit : CurveFitBase
    {
        ...
        public static CubicBezier[] Fit(List<Vector3> points, float maxError)
        {
            ...
            try
            {
                ...
                Vector3 tanL = instance.GetLeftTangent(last);
                Vector3 tanR = instance.GetRightTangent(0);
        ...
        /// </summary>
        private void FitRecursive(int first, int last, Vector3 tanL, Vector3 tanR)
        {
            int split;
            CubicBezier curve;
